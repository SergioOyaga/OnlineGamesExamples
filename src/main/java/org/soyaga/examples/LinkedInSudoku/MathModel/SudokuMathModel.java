...
public class SudokuMathModel extends MathematicalProgrammingModel implements Runnable{
     ...
     */
    public SudokuMathModel(String ID, Integer[][] boardNumbers, int rows, int cols, int rowGroup, int colGroup) {
        super(ID, new SudokuMMInitializer(boardNumbers, rows, cols, rowGroup, colGroup));
    }
