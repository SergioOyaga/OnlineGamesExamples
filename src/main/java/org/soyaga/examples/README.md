...
| 18 | [LinkedInPatches](https://github.com/SergioOyaga/OnlineGamesExamples/tree/master/src/main/java/org/soyaga/examples/LinkedInPatches) | 2                     | LinkedIn PAtches using Mathematical Modeling and Constraint Programing.                                                |
...
18. [LinkedInPatches](https://github.com/SergioOyaga/OnlineGamesExamples/tree/master/src/main/java/org/soyaga/examples/LinkedInPatches):
   This problem involves filling an NxM grid with rectangular colored shapes. The shapes could have location, number, and shape constraints.
